...
export default function QuestionCard({ ques }: { ques: Models.Document }) {
  ...
  return (
    <div
      ref={ref}
      className="relative flex flex-col gap-4 overflow-hidden rounded-xl border border-white/20 bg-white/5 p-4 duration-200 hover:bg-white/10 sm:flex-row m-3"
    >
